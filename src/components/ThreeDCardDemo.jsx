  ...
  return (
    <CardContainer className="inter-var">
      <CardBody
        ...
        w-full sm:w-[28rem] md:w-[32rem] lg:w-[36rem] h-auto rounded-xl p-4 sm:p-6 border"
      >
        <CardItem
          translateZ="50"
        ...
        <CardItem translateZ="100" className="w-full mt-4">
          <img
            ...
            height="1000"
            width="1000"
            className="h-48 sm:h-60 md:h-72 w-full object-cover rounded-xl group-hover/card:shadow-xl"
            alt="thumbnail"
          />
        </CardItem>
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 mt-10 sm:mt-20">
          <CardItem
            translateZ={20}
            as="a"
            href="https://twitter.com/mannupaaji"
            target="__blank"
            className="px-3 py-2 sm:px-4 sm:py-2 rounded-xl text-xs sm:text-sm font-normal dark:text-white"
          >
            Try now →
          </CardItem>
          <CardItem
