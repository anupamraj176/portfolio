...
import portfolioImg from "../assets/portfolio.jpg"; // ✅ fixed name
...
export const Header = () => {
  return (
    <div className="flex flex-col lg:flex-row h-screen pt-10 gap-20 px-[10%] bg-emerald-100">
      ...
      <div className="text-center lg:text-left flex flex-col items-center lg:items-start gap-6">
        ...
        <p className="max-w-xl text-gray-600 text-base sm:text-lg font-Ovo">
